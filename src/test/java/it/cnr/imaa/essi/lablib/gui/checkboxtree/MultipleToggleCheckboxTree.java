...
public class MultipleToggleCheckboxTree extends JTree {
	...
	private class NodeCheckListener extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			...
			if (((CheckboxTreeCellRenderer) getCellRenderer()).isOnHotspot(x
					- rect.x, y - rect.y)) {
				// NEW
				...
				if (selectionPaths != null
						&& Arrays.asList(selectionPaths).contains(clickedPath)) {
	...
	private class SpaceListener extends KeyAdapter {
		...
		public void keyPressed(KeyEvent e) {
			...
			if (e.getKeyCode() == KeyEvent.VK_SPACE) {
				if (path != null) {
					TreeCheckingModel cm = MultipleToggleCheckboxTree.this
							.getCheckingModel();
	...
	public void setCheckingModel(TreeCheckingModel newCheckingModel) {
		...
		if (oldCheckingModel != null
				&& oldCheckingModel instanceof DefaultTreeCheckingModel) {
		...
		if (newCheckingModel != null) {
			if (newCheckingModel instanceof DefaultTreeCheckingModel) {
				((DefaultTreeCheckingModel) newCheckingModel)
						.setTreeModel(getModel());
			}
	...
	public void setModel(TreeModel newModel) {
		...
		if (checkingModel != null
				&& checkingModel instanceof DefaultTreeCheckingModel) {
