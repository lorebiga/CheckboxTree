 ...
 * 02110-1301, USA
 */
package eu.essilab.lablib.gui.checkboxtree.examples;
...
import eu.essilab.lablib.gui.checkboxtree.CheckboxTree;
import eu.essilab.lablib.gui.checkboxtree.TreeCheckingEvent;
import eu.essilab.lablib.gui.checkboxtree.TreeCheckingListener;
...
public class CheckboxTreeExample extends JFrame {
	...
	private class RefreshListener implements KeyListener {
		...
		public void keyPressed(KeyEvent e) {
			TreePath p = CheckboxTreeExample.this.checkboxTree
					.getSelectionPath();
			...
			if (e.getKeyChar() == 'r') {
				if (resource != null) {
					...
					DefaultTreeModel dtm = (DefaultTreeModel) CheckboxTreeExample.this.checkboxTree
							.getModel();
			...
			this.checkboxTree
					.addTreeCheckingListener(new TreeCheckingListener() {
						public void valueChanged(TreeCheckingEvent e) {
							...
							TreePath[] cr = CheckboxTreeExample.this.checkboxTree
									.getCheckingRoots();
