...
public class CheckboxTreeDemo extends JFrame {
	...
	public CheckboxTreeDemo() {
		...
		this.setTitle("CheckboxTree Demo");
		this.createGUI();
	}
	...
	private void createGUI() {
		...
		final CheckingMode modes[] = { CheckingMode.SIMPLE, CheckingMode.PROPAGATE,
				CheckingMode.PROPAGATE_PRESERVING_UNCHECK, CheckingMode.PROPAGATE_PRESERVING_CHECK };
	...
	public static void main(String[] args) {
		CheckboxTreeDemo test = new CheckboxTreeDemo();
