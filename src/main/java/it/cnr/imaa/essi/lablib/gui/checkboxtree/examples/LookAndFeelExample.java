...
public class LookAndFeelExample extends JFrame implements ActionListener {
	...
	private JScrollPane getCheckboxTree() {
		if (this.checkboxTree == null) {
			...
			DefaultMutableTreeNode root = (DefaultMutableTreeNode) this.checkboxTree
					.getModel().getRoot();

			DefaultMutableTreeNode ravioli = (DefaultMutableTreeNode) root
					.getChildAt(2).getChildAt(2);// ravioli;
			...
			((DefaultTreeModel) this.checkboxTree.getModel())
	...
	private JMenuBar getLAFMenuBar() {
		...
		JRadioButtonMenuItem radioAction2 = new JRadioButtonMenuItem(
				"Metal-ocean-theme");
		JRadioButtonMenuItem radioAction4 = new JRadioButtonMenuItem(
				"CDE/Motif");
	...
	public void actionPerformed(ActionEvent action) {
		...
		try {
			...
			System.err.println("Can't use the specified look and feel ("
					+ lafName + ") on this platform.");
			System.err.println("Using the default look and feel.");
		} catch (Exception e) {
			System.err.println("Couldn't get specified look and feel ("
					+ lafName + "), for some reason.");
			System.err.println("Using the default look and feel.");
			e.printStackTrace();
		}
	}
