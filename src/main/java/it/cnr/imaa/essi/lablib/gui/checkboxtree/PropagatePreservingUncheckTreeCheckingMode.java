 ...
 * @author Boldrini
 */
public class PropagatePreservingUncheckTreeCheckingMode extends
		TreeCheckingMode {
	...
	public void checkPath(TreePath path) {
		...
		for (int i = 1; i < parents.length; i++) {
			...
			if (greyAll) {
				...
				case ALL_UNCHECKED:
					System.err
							.println("This should not happen (PropagatePreservingUncheckTreeCheckingMode)");
					break;
				case ALL_CHECKED:
				...
				case NO_CHILDREN:
					System.err
							.println("This should not happen (PropagatePreservingCheckTreeCheckingMode)");
					break;
				}
			}
		}
